...
import com.radware.vision.automation.VisionAutoInfra.CLIInfra.enums.DeployErrors;
...
public class NewVmHandler extends CliTests {
    ...
    private void initialRestLogin(long timeout) {
        try {
            ...
            VisionRestClient visionRestClient = new VisionRestClient(this.visionRadwareFirstTime.getIp(), licenseKey, RestProtocol.HTTPS);
            long startTime = System.currentTimeMillis();
