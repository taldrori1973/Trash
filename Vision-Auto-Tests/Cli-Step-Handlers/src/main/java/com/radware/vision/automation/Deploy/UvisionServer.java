...
public class UvisionServer {
    ...
    public enum DockerServices {
        CONFIG_KVISION_DC_NGINX("config_kvision-dc-nginx_1"),
        CONFIG_KVISION_FORMATTER("config_kvision-formatter_1"),
        CONFIG_KVISION_RT_ALERT("config_kvision-rt-alert_1"),
        CONFIG_KVISION_REPORTER("config_kvision-reporter_1"),
        CONFIG_KVISION_COLLECTOR("config_kvision-collector_1"),
        CONFIG_KVISION_VRM("config_kvision-vrm_1"),
        CONFIG_KVISION_ALERTS("config_kvision-alerts_1"),
        CONFIG_KVISION_CONFIGURATION_SERVICE("config_kvision-configuration-service_1"),
        CONFIG_KVISION_SCHEDULER("config_kvision-scheduler_1"),
        CONFIG_KVISION_TOR_FEED("config_kvision-tor-feed_1"),
        CONFIG_KVISION_CONFIG_SYNC_SERVICE("config_kvision-config-sync-service_1"),
        CONFIG_KVISION_VDIRECT("config_kvision-vdirect_1"),
        CONFIG_KVISION_INFRA_AVR("config_kvision-infra-avr_1"),
        CONFIG_KVISION_INFRA_EFK("config_kvision-infra-efk_1"),
        CONFIG_KVISION_HELP("config_kvision-help_1"),
        CONFIG_KVISION_LLS("config_kvision-lls_1"),
        CONFIG_KVISION_INFRA_RABBITMQ("config_kvision-infra-rabbitmq_1"),
        CONFIG_KVISION_INFRA_IPV6NAT("config_kvision-infra-ipv6nat_1"),
        CONFIG_KVISION_TED("config_kvision-ted_1"),
        CONFIG_KVISION_INFRA_FLUENTD("config_kvision-infra-fluentd_1"),
        CONFIG_KVISION_INFRA_MARIADB("config_kvision-infra-mariadb_1"),
        CONFIG_KVISION_INFRA_AUTOHEAL("config_kvision-infra-autoheal_1"),
        CONFIG_KVISION_WEBUI("config_kvision-webui_1"),
