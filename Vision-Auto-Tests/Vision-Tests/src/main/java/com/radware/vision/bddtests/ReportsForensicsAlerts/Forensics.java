...
public class Forensics extends ReportsForensicsAlertsAbstract {
    ...
    protected JSONObject fillOutputMatch(String productName) {
        ...
        {
            case "defenseflow":
                return new JSONObject("{\"Total Mbits Dropped\":\"packetBandwidth\",\"Device IP Address\":\"deviceIp\",\"Application Name\":\"webApp\",\"Device Host Name\":\"appwallHostName\",\"Received Time\":\"receivedTimeStamp\",\"Total Packets Dropped\":\"packetCount\",\"Destination IP\":\"destAddress\",\"Source IP\":\"sourceAddress\",\"Start Time\":\"startTime\",\"Threat Category\":\"category\",\"Attack Name\":\"name\",\"Policy Name\":\"ruleName\",\"Source IP Address\":\"sourceAddress\",\"Destination IP Address\":\"destAddress\",\"Destination Port\":\"destPort\",\"Direction\":\"direction\",\"Protocol\":\"protocol\",\"Device IP\":\"appwallIP\",\"End Time\":\"endTime\",\"Action\":\"actionType\",\"Attack ID\":\"attackIpsId\",\"Source Port\":\"sourcePort\",\"Radware ID\":\"radwareId\",\"Duration\":\"duration\",\"Max pps\":\"maxAttackPacketRatePps\",\"Max bps\":\"maxAttackRateBps\",\"Physical Port\":\"physicalPort\",\"Risk\":\"risk\",\"VLAN Tag\":\"vlanTag\",\"Packet Type\":\"packetType\"}");
            case "appwall":
                return new JSONObject("{\"User Name\":\"user\",\"Tunnel\":\"tunnel\",\"Transaction ID\":\"transId\",\"Severity\":\"severity\",\"Module\":\"module\",\"Directory\":\"directory\",\"Event Description\":\"details\",\"Cluster Manager IP\":\"clusterManagerIp\",\"Web Application Name\":\"webApp\",\"Device Host Name\":\"appwallHostName\",\"Date and Time\":\"receivedTimeStamp\",\"Packets\":\"packetCount\",\"Destination IP\":\"destAddress\",\"Source IP\":\"sourceIp\",\"Start Time\":\"startTime\",\"Threat Category\":\"violationCategory\",\"Attack Name\":\"title\",\"Policy Name\":\"ruleName\",\"Source IP Address\":\"sourceIp\",\"Destination IP Address\":\"destinationIp\",\"Destination Port\":\"destPort\",\"Direction\":\"direction\",\"Protocol\":\"protocol\",\"Device IP\":\"appwallIP\",\"End Time\":\"endTime\",\"Action\":\"action\",\"Attack ID\":\"attackIpsId\",\"Source Port\":\"sourcePort\",\"Radware ID\":\"radwareId\",\"Duration\":\"duration\",\"Max pps\":\"maxAttackPacketRatePps\",\"Max bps\":\"maxAttackRateBps\",\"Physical Port\":\"physicalPort\",\"Risk\":\"risk\",\"VLAN Tag\":\"vlanTag\",\"Packet Type\":\"packetType\"}");
            case "":
            case "defensepro":
            default:
                return new JSONObject("{\"Total Mbits Dropped\":\"packetBandwidth\",\"Total Packets Dropped\":\"packetCount\",\"Device IP Address\":\"deviceIp\",\"Application Name\":\"webApp\",\"Device Host Name\":\"appwallHostName\",\"Received Time\":\"receivedTimeStamp\",\"Packets\":\"packetCount\",\"Destination IP\":\"destAddress\",\"Source IP\":\"sourceAddress\",\"Start Time\":\"startTime\",\"Threat Category\":\"category\",\"Attack Name\":\"name\",\"Policy Name\":\"ruleName\",\"Source IP Address\":\"sourceAddress\",\"Destination IP Address\":\"destAddress\",\"Destination Port\":\"destPort\",\"Direction\":\"direction\",\"Protocol\":\"protocol\",\"Device IP\":\"appwallIP\",\"End Time\":\"endTime\",\"Action\":\"actionType\",\"Attack ID\":\"attackIpsId\",\"Source Port\":\"sourcePort\",\"Radware ID\":\"radwareId\",\"Duration\":\"duration\",\"Max pps\":\"maxAttackPacketRatePps\",\"Max bps\":\"maxAttackRateBps\",\"Physical Port\":\"physicalPort\",\"Risk\":\"risk\",\"VLAN Tag\":\"vlanTag\",\"Packet Type\":\"packetType\"}");
        }
    }
        ...
        switch (map.getOrDefault("Product", "").toLowerCase()) {
            ...
            case "appwall":
                ...
                if (map.containsKey("Application"))
                    new TemplateHandlers.AWScopeSelection(new JSONArray("[" + map.get("Application") + "]"), "", "APPLICATIONS").create();
                break;
        }
    }
