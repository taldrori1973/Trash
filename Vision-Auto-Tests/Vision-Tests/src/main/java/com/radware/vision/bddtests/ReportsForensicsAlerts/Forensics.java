...
public class Forensics extends ReportsForensicsAlertsAbstract {
    ...
    protected JSONObject fillOutputMatch(String productName) {
        switch (productName.toLowerCase())
        {
            ...
            case "appwall":
                return new JSONObject("{\"User Name\":\"user\",\"Tunnel\":\"tunnel\",\"Transaction ID\":\"transId\",\"Severity\":\"severity\",\"Module\":\"Module\",\"Directory\":\"directory\",\"Attack Name\":\"title\",\"Event Description\":\"details\",\"Cluster Manager IP\":\"clusterManagerIp\",\"Web Application Name\":\"webApp\",\"Device Host Name\":\"appwallHostName\",\"Date and Time\":\"receivedTimeStamp\",\"Packets\":\"packetCount\",\"Destination IP\":\"destAddress\",\"Source IP\":\"sourceIp\",\"Start Time\":\"startTime\",\"Threat Category\":\"violationCategory\",\"Attack Name\":\"name\",\"Policy Name\":\"ruleName\",\"Source IP Address\":\"sourceIp\",\"Destination IP Address\":\"destinationIp\",\"Destination Port\":\"destPort\",\"Direction\":\"direction\",\"Protocol\":\"protocol\",\"Device IP\":\"appwallIP\",\"End Time\":\"endTime\",\"Action\":\"action\",\"Attack ID\":\"attackIpsId\",\"Source Port\":\"sourcePort\",\"Radware ID\":\"radwareId\",\"Duration\":\"duration\",\"Max pps\":\"maxAttackPacketRatePps\",\"Max bps\":\"maxAttackRateBps\",\"Physical Port\":\"physicalPort\",\"Risk\":\"risk\",\"VLAN Tag\":\"vlanTag\",\"Packet Type\":\"packetType\"}");
            case "":
            case "defensepro":
            default:
