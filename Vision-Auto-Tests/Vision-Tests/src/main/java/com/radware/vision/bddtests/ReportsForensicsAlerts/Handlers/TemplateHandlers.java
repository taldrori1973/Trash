...
//        return elements.size() != 0 ? elements.get(elements.size() - 1).getText() : reportType;
    ...
    public static abstract class ScopeSelection {
        ...
        public void create() throws Exception {
            ...
            } else if (type.equals("AppWall") || type.equalsIgnoreCase("APPLICATION") || type.equals("System and Network") || type.equals("LinkProof")) {
                if (!isAllAndClearScopeSelection()) {
                    for (Object deviceJSON : devicesJSON)
                        selectDevice(deviceJSON.toString(), true);
        ...
        void selectDevice(String deviceText, boolean isToCheck) throws Exception {
            if (type.equals("DefensePro Analytics") || type.equals("DefenseFlow Analytics") || type.equals("AppWall") || type.equals("ERT Active Attackers Feed") || type.equals("ERT Active Attackers Audit Report") || type.equals("PROTECTED OBJECTS") || type.equalsIgnoreCase("APPLICATION") || type.equals("System and Network") || type.equals("LinkProof")) {
