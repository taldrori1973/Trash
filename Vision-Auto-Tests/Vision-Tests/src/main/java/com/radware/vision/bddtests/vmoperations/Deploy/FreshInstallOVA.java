...
public class FreshInstallOVA extends FreshInstall {
    ...
    public void deploy() {
        ...
        List<InterfaceDto> networks = getSutManager().getInterfaces();
        ...
        try {
            vmHandler.firstTimeWizardOva(super.getBuildFileInfo().getDownloadUri().toString(), vCenterURL, vCenterUser, vCenterPassword, hostIp,
                    super.getBuild(), vmName, null, networks, resourcePool, null, dataStores);
        } catch (Exception e) {
