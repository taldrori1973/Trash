...
# validate top charts section
  ...
  Scenario: Validate Dashboards "Top Application by Throughput" Chart data values for all virtual service - default view
    Then UI Text of "TopByThroughput_virtName" with extension "0" equal to "1_#convertIpToHexa(Alteon_Sim_Set_2);:80"
    ...
    Then  UI Validate element "TopByThroughput_progress" attribute with param "1"
      | name  | value      |
      | style | width: 53% |
    Then UI Text of "TopByThroughput_virtName" with extension "2" equal to "Rejith_#convertIpToHexa(Alteon_Sim_Set_2);:443"
  ...
  Scenario: Validate Dashboards "Top Application by Request Per Second" Chart data values for all virtual service - default view
    Then UI Text of "TopByRPS_virtName" with extension "0" equal to "1_#convertIpToHexa(Alteon_Sim_Set_2);:80"
    ...
    Then UI Validate element "TopByRPS_progress" attribute with param "1"
      | name  | value      |
      | style | width: 55% |
    Then UI Text of "TopByRPS_virtName" with extension "2" equal to "Rejith_#convertIpToHexa(Alteon_Sim_Set_2);:443"
    ...
    Then UI Validate element "TopByRPS_progress" attribute with param "2"
      | name  | value      |
      | style | width: 28% |
    Then UI Text of "TopByRPS_virtName" with extension "3" equal to "Rejith_#convertIpToHexa(Alteon_Sim_Set_2);:80"
...
#      | Real Servers(Up/Total) | 0/7            |
    ...
    Then UI Validate Table record values by columns with elementLabel "virts table" findBy columnName "Application Name" findBy cellValue "1234_#convertIpToHexa(Alteon_Sim_Set_2);:80"
      | columnName             | value            |
...
#    Then UI Text of "Statistics.Summary" with extension "Throughput" equal to "4.29 M"
  ...
  # Top Application by Throughput Chart validation
    ...
    Then UI Validate element "TopByThroughput_progress" attribute with param "0"
      | name  | value       |
      | style | width: 100% |
    Then UI Text of "TopByThroughput_virtName" with extension "1" equal to "Rejith_#convertIpToHexa(Alteon_Sim_Set_2);:443"
  ...
  # Top Application by RPS Chart validation
    ...
    Then UI Validate element "TopByRPS_progress" attribute with param "0"
      | name  | value       |
      | style | width: 100% |
    Then UI Text of "TopByRPS_virtName" with extension "1" equal to "Rejith_#convertIpToHexa(Alteon_Sim_Set_2);:443"
    Then UI Text of "TopByRPS_value" with extension "1" equal to "129"
    Then UI Validate element "TopByRPS_progress" attribute with param "1"
      | name  | value      |
      | style | width: 28% |
    Then UI Text of "TopByRPS_virtName" with extension "2" equal to "Rejith_#convertIpToHexa(Alteon_Sim_Set_2);:88"
