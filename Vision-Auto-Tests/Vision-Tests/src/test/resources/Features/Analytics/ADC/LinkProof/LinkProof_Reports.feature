...
Feature: LinkProof_Reports
  ...
  Scenario: create new CEC2
    ...
    Given UI "Create" Report With Name "CEC2"
      | Template              | reportType:LinkProof ,Widgets:[CEC] , devices:[LinkProof 172.19.88.5] ,WANLinks:[w1] |
  ...
  Scenario: create new CEC3
    ...
    Given UI "Create" Report With Name "CEC3"
      | Template              | reportType:LinkProof ,Widgets:[CEC] , devices:[LinkProof 172.19.88.5] ,WANLinks:[w1,Ahlam_WAN] |
  ...
  Scenario: create new CEC5
    ...
    Given UI "Create" Report With Name "CEC5"
      | Template              | reportType:LinkProof ,Widgets:[CEC] , devices:[LinkProof 172.19.88.5] ,WANLinks:[Giora123,mansour_1,w1,w2,Radware1,EdiWanLinks] |
  ...
  Scenario: create new Download throughput bps1
    ...
    Given UI "Create" Report With Name "Download throughput bps1"
      | Template              | reportType:LinkProof ,Widgets:[{Download throughput:[bps]}] , devices:[LinkProof 172.19.88.5] ,WANLinks:[w1,w2] |
      | Logo                  | reportLogoPNG.png                                                                                               |
      | Time Definitions.Date | Quick:1D                                                                                                        |
  ...
  Scenario: create new Download throughput bps4
    ...
    Given UI "Create" Report With Name "Download throughput bps4"
      | Template              | reportType:LinkProof ,Widgets:[{Download throughput:[bps]}] , devices:[LinkProof 172.19.88.5] ,WANLinks:[Giora123,mansour_1,w1,w2,Radware1,EdiWanLinks] |
      | Logo                  | reportLogoPNG.png                                                                                                                                       |
      | Time Definitions.Date | Absolute:[02.11.2020 13:47, +0d]                                                                                                                        |
      | Format                | Select: CSV                                                                                                                                             |
  ...
  Scenario: create new Download throughput Usage1
    ...
    Given UI "Create" Report With Name "Download throughput Usage1"
      | Template              | reportType:LinkProof ,Widgets:[{Download throughput:[Usage]}] , devices:[LinkProof 172.19.88.5] ,WANLinks:[w1,w2] |
      | Logo                  | reportLogoPNG.png                                                                                                 |
      | Time Definitions.Date | Quick:1D                                                                                                          |
      | Schedule              | Run Every:Daily ,On Time:+2m                                                                                      |
      | share                 | Email:[automation.vision1@radware.com],Subject:mySubject,Body:myBody                                              |
  ...
  Scenario: create new Download throughput Usage4
    ...
    Given UI "Create" Report With Name "Download throughput Usage4"
      | Template              | reportType:LinkProof ,Widgets:[{Download throughput:[Usage]}] , devices:[LinkProof 172.19.88.5] ,WANLinks:[Giora123,mansour_1,w1,w2,Radware1,EdiWanLinks] |
      | Logo                  | reportLogoPNG.png                                                                                                                                         |
  ...
  Scenario: create new Upload throughput bps1
    ...
    Given UI "Create" Report With Name "Upload throughput bps1"
      | Template              | reportType:LinkProof ,Widgets:[{Upload throughput:[bps]}] , devices:[LinkProof 172.19.88.5] ,WANLinks:[w1,w2] |
      | Logo                  | reportLogoPNG.png                                                                                             |
      | Time Definitions.Date | Quick:1D                                                                                                      |
      | Schedule              | Run Every:Daily ,On Time:+2m                                                                                  |
      | share                 | Email:[automation.vision1@radware.com],Subject:mySubject,Body:myBody                                          |
  ...
  Scenario: create new Upload throughput bps4
    ...
    Given UI "Create" Report With Name "Upload throughput bps4"
      | Template              | reportType:LinkProof ,Widgets:[{Upload throughput:[bps]}] , devices:[LinkProof 172.19.88.5] ,WANLinks:[Giora123,mansour_1,w1,w2,Radware1,EdiWanLinks] |
      | Logo                  | reportLogoPNG.png                                                                                                                                     |
      | Time Definitions.Date | Absolute:[02.11.2020 13:47, +0d]                                                                                                                      |
      | Format                | Select: CSV                                                                                                                                           |
  ...
  Scenario: create new Upload throughput Usage1
    ...
    Given UI "Create" Report With Name "Upload throughput Usage1"
      | Template              | reportType:LinkProof ,Widgets:[{Upload throughput:[Usage]}] , devices:[LinkProof 172.19.88.5] ,WANLinks:[w1,w2] |
      | Logo                  | reportLogoPNG.png                                                                                               |
      | Time Definitions.Date | Quick:1D                                                                                                        |
      | Schedule              | Run Every:Daily ,On Time:+2m                                                                                    |
      | share                 | Email:[automation.vision1@radware.com],Subject:mySubject,Body:myBody                                            |
  ...
  Scenario: create new Upload throughput Usage4
    ...
    Given UI "Create" Report With Name "Upload throughput Usage4"
      | Template              | reportType:LinkProof ,Widgets:[{Upload throughput:[Usage]}] , devices:[LinkProof 172.19.88.5] ,WANLinks:[Giora123,mansour_1,w1,w2,Radware1,EdiWanLinks] |
      | Logo                  | reportLogoPNG.png                                                                                                                                       |
      | Time Definitions.Date | Relative:[Months,2]                                                                                                                                     |
      | Format                | Select: CSV                                                                                                                                             |
  ...
  Scenario: create new CEC Download throughput bps
    Given UI "Create" Report With Name "CEC Download throughput bps"
      | Template              | reportType:LinkProof ,  Widgets:[{Download throughput:[bps]},CEC] , devices:[LinkProof 172.19.88.5] ,WANLinks:[w1,w2] |
      | Logo                  | reportLogoPNG.png                                                                                                     |
      | Format                | Select: PDF                                                                                                           |
      | Schedule              | Run Every:Monthly, On Time:+6H, At Months:[JAN]                                                                       |
      | Time Definitions.Date | Quick:Today                                                                                                           |
  ...
  Scenario: create new CEC Download throughput Usage
    ...
    Given UI "Create" Report With Name "CEC Download throughput Usage"
      | Template              | reportType:LinkProof ,Widgets:[{Download throughput:[Usage]},CEC] , devices:[LinkProof 172.19.88.5] ,WANLinks:[w1] |
      | Schedule              | Run Every:Weekly, On Time:+6H, At Days:[WED]                                                                       |
      | Time Definitions.Date | Quick:Yesterday                                                                                                    |
      | share                 | Email:[automation.vision1@radware.com],Subject:mySubject,Body:myBody                                               |
      | Format                | Select: HTML                                                                                                       |
  ...
  Scenario: create new CEC Upload throughput bps
    ...
    Given UI "Create" Report With Name "CEC Upload throughput bps"
      | Template              | reportType:LinkProof ,Widgets:[{Upload throughput:[bps]},CEC] , devices:[LinkProof 172.19.88.5] ,WANLinks:[w1,Ahlam_WAN] |
      | Time Definitions.Date | Absolute:[02.11.2020 13:47, +0d]                                                                                         |
      | Format                | Select: CSV                                                                                                              |
  ...
  Scenario: create new CEC Upload throughput Usage
    ...
    Given UI "Create" Report With Name "CEC Upload throughput Usage"
      | Template              | reportType:LinkProof ,Widgets:[{Upload throughput:[Usage]},CEC] , devices:[LinkProof 172.19.88.5] ,WANLinks:[w1,Ahlam_WAN] |
      | Time Definitions.Date | Relative:[Days,3]                                                                                                          |
      | Schedule              | Run Every:Monthly, On Time:+6H, At Months:[FEB,MAR,JUL,AUG]                                                                |
      | Format                | Select: HTML                                                                                                               |
  ...
  Scenario: create new Download throughput Usage Upload throughput Usage1
    ...
    Given UI "Create" Report With Name "Download throughput Usage Upload throughput Usage1"
      | Template              | reportType:LinkProof ,Widgets:[{Upload throughput:[Usage]},{Download throughput:[Usage]}] , devices:[LinkProof 172.19.88.5] ,WANLinks:[Giora123,mansour_1,w1,w2,Radware1,EdiWanLinks] |
      | Time Definitions.Date | Quick:1D                                                                                                                                                                              |
      | Schedule              | Run Every:Monthly, On Time:+6H, At Months:[FEB,MAR,JUL,AUG]                                                                                                                           |
      | share                 | Email:[automation.vision1@radware.com],Subject:mySubject,Body:myBody                                                                                                                  |
      | Format                | Select: HTML                                                                                                                                                                          |
  ...
  Scenario: create new Download throughput Usage Upload throughput bps1
    ...
    Given UI "Create" Report With Name "Download throughput bps Upload throughput Usage1"
      | Template              | reportType:LinkProof ,Widgets:[{Upload throughput:[bps]},{Download throughput:[Usage]}] , devices:[LinkProof 172.19.88.5] ,WANLinks:[w1,w2] |
      | Logo                  | reportLogoPNG.png                                                                                                                           |
      | Time Definitions.Date | Quick:1D                                                                                                                                    |
      | Schedule              | Run Every:Daily ,On Time:+2m                                                                                                                |
      | share                 | Email:[automation.vision1@radware.com],Subject:mySubject,Body:myBody                                                                        |
  ...
  Scenario: create new Download throughput bps Upload throughput Usage1
    Then UI Click Button "New Report Tab"
    Given UI "Create" Report With Name "Download throughput bps Upload throughput Usage1"
      | Template              | reportType:LinkProof ,Widgets:[{Upload throughput:[Usage]},{Download throughput:[bps]}] , devices:[LinkProof 172.19.88.5] ,WANLinks:[w1,w2] |
      | Logo                  | reportLogoPNG.png                                                                                                                           |
      | Time Definitions.Date | Relative:[Hours,3]                                                                                                                          |
      | Schedule              | Run Every:Monthly, On Time:+6H, At Months:[DEC]                                                                                             |
      | share                 | Email:[automation.vision1@radware.com],Subject:mySubject,Body:myBody                                                                        |
  ...
  Scenario: create new Download throughput bps Upload throughput Usage2
    ...
    Given UI "Create" Report With Name "Download throughput bps Upload throughput Usage2"
      | Template              | reportType:LinkProof ,Widgets:[{Upload throughput:[Usage]},{Download throughput:[bps]}] , devices:[LinkProof 172.19.88.5] ,WANLinks:[Giora123,mansour_1,w1,w2,Radware1,EdiWanLinks] |
      | Logo                  | reportLogoPNG.png                                                                                                                                                                   |
      | Time Definitions.Date | Absolute:[02.11.2020 13:47, +0d]                                                                                                                                                    |
      | Format                | Select: CSV                                                                                                                                                                         |
  ...
  Scenario: create new Download throughput bps Upload throughput bps1
    ...
    Given UI "Create" Report With Name "Download throughput bps Upload throughput bps1"
      | Template              | reportType:LinkProof ,Widgets:[{Upload throughput:[bps]},{Download throughput:[bps]}] , devices:[LinkProof 172.19.88.5] ,WANLinks:[w1,w2] |
      | Logo                  | reportLogoPNG.png                                                                                                                         |
      | Time Definitions.Date | Quick:1D                                                                                                                                  |
      | Schedule              | Run Every:Daily ,On Time:+2m                                                                                                              |
      | share                 | Email:[automation.vision1@radware.com],Subject:mySubject,Body:myBody                                                                      |
  ...
  Scenario: create new CEC Download throughput Usage Upload throughput Usage1
    ...
    Given UI "Create" Report With Name "CEC Download throughput Usage Upload throughput Usage1"
      | Template              | reportType:LinkProof ,Widgets:[CEC,{Upload throughput:[Usage]},{Download throughput:[Usage]}] , devices:[LinkProof 172.19.88.5] ,WANLinks:[w1,w2] |
      | Logo                  | reportLogoPNG.png                                                                                                                                 |
      | Time Definitions.Date | Relative:[Hours,3]                                                                                                                                |
      | Schedule              | Run Every:Monthly, On Time:+6H, At Months:[DEC]                                                                                                   |
      | share                 | Email:[automation.vision1@radware.com],Subject:mySubject,Body:myBody                                                                              |
  ...
  Scenario: create new CEC Download throughput Usage Upload throughput Usage2
    ...
    Given UI "Create" Report With Name "CEC Download throughput Usage Upload throughput Usage2"
      | Template              | reportType:LinkProof ,Widgets:[CEC,{Upload throughput:[Usage]},{Download throughput:[Usage]}] , devices:[LinkProof 172.19.88.5] ,WANLinks:[Giora123,mansour_1,w1,w2,Radware1,EdiWanLinks] |
      | Logo                  | reportLogoPNG.png                                                                                                                                                                         |
      | Time Definitions.Date | Relative:[Months,2]                                                                                                                                                                       |
      | Format                | Select: CSV                                                                                                                                                                               |
  ...
  Scenario: create new CEC Download throughput bps Upload throughput bps1
    ...
    Given UI "Create" Report With Name "CEC Download throughput bps Upload throughput bps1"
      | Template              | reportType:LinkProof ,Widgets:[CEC,{Upload throughput:[bps]},{Download throughput:[bps]}] , devices:[LinkProof 172.19.88.5] ,WANLinks:[w1,w2] |
      | Logo                  | reportLogoPNG.png                                                                                                                             |
      | Time Definitions.Date | Quick:1D                                                                                                                                      |
      | Schedule              | Run Every:Daily ,On Time:+2m                                                                                                                  |
      | share                 | Email:[automation.vision1@radware.com],Subject:mySubject,Body:myBody                                                                          |
