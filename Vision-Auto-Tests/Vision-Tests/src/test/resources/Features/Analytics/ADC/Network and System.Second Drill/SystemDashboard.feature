...
Feature: ADC System Dashboard
  ...
  Scenario: Go into system dashboard
    ...
    Then UI Select scope from dashboard and Save Filter device type "Alteon"
      | #getSUTValue(setID:Alteon_Sim_Set_2); |
    Then UI click Table row by keyValue or Index with elementLabel "Devices table" findBy columnName "Device Name" findBy cellValue "#getSUTValue(setID:Alteon_Sim_Set_2);"
