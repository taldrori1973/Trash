...
Feature: Edit ADC Report tests
  ...
  Scenario: Create and validate ADC Report
    ...
    Given UI "Create" Report With Name "ADC Report"
      | Template-1            | reportType:Application ,Widgets:[Concurrent Connections] , Applications:[Rejith_32326515:80]                             |
  ...
  Scenario: Add Template Widget to ADC Report
    Given UI "Edit" Report With Name "ADC Report"
      | Template-1 | reportType:Application ,AddWidgets:[End-to-End Time] , Applications:[Rejith_32326515:80] |
    Then UI "Validate" Report With Name "ADC Report"
      | Template-1 | reportType:Application ,Widgets:[Concurrent Connections,End-to-End Time] , Applications:[Rejith_32326515:80] |

  @SID_4
  Scenario: Delete Template Widget from ADC Report
    Given UI "Edit" Report With Name "ADC Report"
      | Template-1 | reportType:Application ,DeleteWidgets:[End-to-End Time] , Applications:[Rejith_32326515:80] |
    Then UI "Validate" Report With Name "ADC Report"
      | Template-1 | reportType:Application ,Widgets:[Concurrent Connections] , Applications:[Rejith_32326515:80] |
