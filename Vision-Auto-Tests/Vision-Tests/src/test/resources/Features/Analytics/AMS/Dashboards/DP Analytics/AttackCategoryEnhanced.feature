...
Feature: Attack Category Enhanced
  ...
  Scenario: Validate Attacks by Threat Category Labels and Value
    ...
    Then UI Validate Value from more options in pie chart "Attacks by Threat Category" Equal to "6.06%" with label "Anti-Scanning" with offset "3"

    Then UI Validate Labels from more options in pie chart "Attacks by Threat Category" Equal to "DOSShield"
    Then UI Validate Value from more options in pie chart "Attacks by Threat Category" Equal to "6.06%" with label "DOSShield" with offset "3"

    Then UI Validate Labels from more options in pie chart "Attacks by Threat Category" Equal to "Anomalies"
    Then UI Validate Value from more options in pie chart "Attacks by Threat Category" Equal to "3.03%" with label "Anomalies" with offset "3"
  ...
  Scenario: Validate Top Attack Sources Labels and Value
    ...
    Then UI Text of "Top Attack Sources Value" with extension "Multiple" GTE to "33% (9)" with offset "3"

    Then UI Text of "Top Attack Sources Label" with extension "149.85.1.2" equal to "149.85.1.2"
    Then UI Text of "Top Attack Sources Value" with extension "149.85.1.2" GTE to "25% (7)" with offset "3"

    Then UI Text of "Top Attack Sources Label" with extension "2.2.2.1" equal to "2.2.2.1"
    Then UI Text of "Top Attack Sources Value" with extension "2.2.2.1" GTE to "11% (3)" with offset "3"

    Then UI Text of "Top Attack Sources Label" with extension "192.85.1.7" equal to "192.85.1.7"
    Then UI Text of "Top Attack Sources Value" with extension "192.85.1.7" GTE to "7% (2)" with offset "3"

    Then UI Validate Labels from more options in pie chart "Top Attack Sources" Equal to "0.0.0.0"
    Then UI Validate Value from more options in pie chart "Top Attack Sources" Equal to "3.85%" with label "0.0.0.0" with offset "3"

    Then UI Validate Labels from more options in pie chart "Top Attack Sources" Equal to "1.1.1.1"
    Then UI Validate Value from more options in pie chart "Top Attack Sources" Equal to "3.85%" with label "1.1.1.1" with offset "3"

    Then UI Validate Labels from more options in pie chart "Top Attack Sources" Equal to "1.3.5.8"
    Then UI Validate Value from more options in pie chart "Top Attack Sources" Equal to "3.85%" with label "1.3.5.8" with offset "3"

    Then UI Validate Labels from more options in pie chart "Top Attack Sources" Equal to "100.1.1.1"
    Then UI Validate Value from more options in pie chart "Top Attack Sources" Equal to "3.85%" with label "100.1.1.1" with offset "3"

    Then UI Validate Labels from more options in pie chart "Top Attack Sources" Equal to "12.12.12.12"
    Then UI Validate Value from more options in pie chart "Top Attack Sources" Equal to "3.85%" with label "12.12.12.12" with offset "3"

    Then UI Validate Labels from more options in pie chart "Top Attack Sources" Equal to "15.15.15.15"
    Then UI Validate Value from more options in pie chart "Top Attack Sources" Equal to "3.85%" with label "15.15.15.15" with offset "3"
