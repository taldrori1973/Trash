@TC123478
  Feature: QDos Quantile Traffic Bandwidth New Widget
...
#      * CLI kill all simulator attacks on current vision
    ...
    Scenario: validate QDos State attack ID 38-1630605835
      ...
      Then UI Validate Line Chart data "Quantile Traffic Bandwidth" with Label "Received"
        | value  | count |
        | 26152  | 1   |
        | 25818  | 1   |
        | 25870  | 1   |
        ...
        | 25491  | 1   |
        | 25430  | 1   |
      And UI Validate Line Chart data "Quantile Traffic Bandwidth" with Label "Dropped"
        | value  | count |
        | 26074  | 1   |
        | 25607  | 1   |
        | 25922  | 1   |
        ...
        | 25852  | 1   |
        | 25794  | 1   |
      And UI Validate Line Chart data "Quantile Traffic Bandwidth" with Label "Attack Edge"
        | value  | count |
        | 3529  | 9   |
