...
# #06 #############################################################################################################################################
  ...
  Scenario: VRM - Add New Forensics criteria - Action - Equals
    ...
    Then UI Validate "Forensics.Table" Table rows count EQUALS to 25 with offset 5
  ...
  Scenario: VRM - Add New Forensics criteria - Action - Not Equals
    ...
    Then UI Validate "Forensics.Table" Table rows count EQUALS to 9 with offset 3
  ...
  Scenario: VRM - Add New Forensics criteria - Attack Name - Equals
    ...
    Then UI Validate "Forensics.Table" Table rows count EQUALS to 4 with offset 3
    Then UI Validate Table record values by columns with elementLabel "Forensics.Table" findBy index 0
      | columnName  | value                   |
  ...
  Scenario: VRM - Add New Forensics criteria - Attack Name - Not Equals
    ...
    Then UI Validate "Forensics.Table" Table rows count EQUALS to 30 with offset 3
  ...
  Scenario: VRM - Add New Forensics criteria - Destination IP - Equals
    ...
    Then UI Validate "Forensics.Table" Table rows count EQUALS to 2 with offset 3
  ...
  Scenario: VRM - Add New Forensics criteria - Destination Range - Not Equals
    ...
    Then UI Validate "Forensics.Table" Table rows count EQUALS to 32 with offset 3
  ...
  Scenario: VRM - Add New Forensics criteria - Destination Port - Equals
    ...
    Then UI Validate "Forensics.Table" Table rows count EQUALS to 7 with offset 3
  ...
  Scenario: VRM - Add New Forensics criteria - Destination Port - Not Equals
    ...
    Then UI Validate "Forensics.Table" Table rows count EQUALS to 27 with offset 3
  ...
  Scenario: VRM - Add New Forensics criteria - Direction - Equals
    ...
    Then UI Validate "Forensics.Table" Table rows count EQUALS to 14 with offset 3
    Then UI Validate Table record values by columns with elementLabel "Forensics.Table" findBy index 0
      | columnName | value |
      | Direction  | In    |
  ...
  Scenario: VRM - Add New Forensics criteria - Duration - Equals
    ...
    Then UI Validate "Forensics.Table" Table rows count EQUALS to 0 with offset 3
  ...
  Scenario: VRM - Add New Forensics criteria - Duration - Not Equals
    ...
    Then UI Validate "Forensics.Table" Table rows count EQUALS to 34 with offset 3
...
# ###########################################################################
  ...
  Scenario: VRM - Add New Forensics criteria - Source Port - Equals
    ...
    Then UI Validate "Forensics.Table" Table rows count EQUALS to 16 with offset 3
  ...
  Scenario: VRM - Add New Forensics criteria - Source Port - Not Equals
    ...
    Then UI Validate "Forensics.Table" Table rows count EQUALS to 18 with offset 3
...
# 11 ##################################################################################################################
  ...
  Scenario: VRM - Forensics criteria - All Conditions
    ...
    Then UI Validate "Forensics.Table" Table rows count EQUALS to 6 with offset 3
...
#      | Attack ID  | 37-1491757775 |
  ...
  Scenario: VRM - Forensics criteria - Any Condition
    ...
    Then UI Validate "Forensics.Table" Table rows count EQUALS to 31 with offset 3
