...
Feature: Forensics Edit Definition
  ...
  Scenario: forensics definition edit forensic name
    When UI "Edit" Forensics With Name "Test Edit"
      | Basic Info            | Description:,forensics name:EDIT_1 |
#    Then UI Click Button "Edit" with value "Test Edit"
#    Then UI Set Text Field "Name TextField" To "EDIT_1"
#    Then UI Click Button "Submit" with value "Submit"

  @SID_6
  Scenario: forensics definition edit all fields
    When UI "Edit" Forensics With Name "EDIT_1"
      | Basic Info            | Description:desc                                         |
      | devices               | index:11, policies:[BDOS];                               |
...
#    And UI Click Button "Edit" with value "EDIT_1"
#    And UI Click Button "Summary Card" with value "initial"
#    Then UI Validate Text field "Summary.Name" EQUALS "Name: EDIT_1"
