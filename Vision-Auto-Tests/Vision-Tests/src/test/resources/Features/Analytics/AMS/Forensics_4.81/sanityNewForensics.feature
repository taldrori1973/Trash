...
#############################################  AppWall ###############################################
  ...
  Scenario: Validate Criteria Attack ID Attribute
    ...
    Then UI Validate Text field "Criteria Error Message" EQUALS "Please enter a valid numeric input"
  ...
  Scenario: Validate Criteria Destination IP Attribute
    ...
    Then UI Validate Text field "Criteria Error Message" EQUALS "Please enter a valid IP address"
...
#    --------------------------------------------IPv6----------------------------------------------------------
  ...
  Scenario: Validate Criteria Destination Port Attribute
    ...
    Then UI Validate Text field "Criteria Error Message" EQUALS "Please enter a valid port number"
#    ---------------------------------------------Single----------------------------
