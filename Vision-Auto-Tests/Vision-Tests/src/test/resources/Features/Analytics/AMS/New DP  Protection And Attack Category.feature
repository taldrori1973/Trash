...
#    Then Sleep "30"
  ...
  @SID_3
  Scenario: navigate to alert and Create Alert Category with name Encrypted_Flood    Application Protection
    ...
    Then UI "Edit" Alerts With Name "Encrypted_Flood"
      | Basic Info | Severity:Critical |
