...
Feature: EAAF
  ...
  Scenario: create new Top Malicious IP Addresses3
    Given UI "Create" Report With Name "Top Malicious IP Addresses3"
      | Template              | reportType:ERT Active Attackers Feed , Widgets:[{Top Malicious IP Addresses:[Attacks]}],devices:[All] |
  ...
  Scenario: create new Top Attacking Geolocations1
    Given UI "Create" Report With Name "Top Attacking Geolocations1"
      | Template              | reportType:ERT Active Attackers Feed , Widgets:[{Top Attacking Geolocations:[Attacks]}],devices:[All] |
      | Logo                  | reportLogoPNG.png                                                               |
      | Time Definitions.Date | Quick:This Week                                                                 |
      | Schedule              | Run Every:Daily,On Time:+2m                                                     |
      | Format                | Select: CSV                                                                     |
  ...
  Scenario: create new Breakdown by Malicious Activity3
    Given UI "Create" Report With Name "Breakdown by Malicious Activity3"
      | Template              | reportType:ERT Active Attackers Feed , Widgets:[{Breakdown by Malicious Activity:[Attacks]}],devices:[All] |
      | Time Definitions.Date | Relative:[Weeks,2]                                                                   |
      | Format                | Select: HTML                                                                         |
  ...
  Scenario: create new EAAF Hits Timeline3
    Given UI "Create" Report With Name "EAAF Hits Timeline3"
      | Template              | reportType:ERT Active Attackers Feed , Widgets:[{EAAF Hits Timeline:[Attacks]}],devices:[All] |
      | Time Definitions.Date | Absolute:[27.02.1971 01:00, +0d]                                     |
  ...
  Scenario: create new Top Malicious IP Addresses and Breakdown by Malicious Activity and EAAF Hits Timeline1
    Given UI "Create" Report With Name "Top Malicious IP Addresses and Breakdown by Malicious Activity and EAAF Hits Timeline1"
      | Template              | reportType:ERT Active Attackers Feed , Widgets:[{Top Malicious IP Addresses:[Attacks]},{Breakdown by Malicious Activity:[Attacks]},{EAAF Hits Timeline:[Attacks]}] ,devices:[All] |
      | Logo                  | reportLogoPNG.png                                                                                                                                         |
      | Time Definitions.Date | Quick:15m                                                                                                                                                 |
      | Format                | Select: CSV                                                                                                                                               |
  ...
  Scenario: create new Top Malicious IP Addresses and Breakdown by Malicious Activity and EAAF Hits Timeline4
    Given UI "Create" Report With Name "Top Malicious IP Addresses and Breakdown by Malicious Activity and EAAF Hits Timeline4"
      | Template              | reportType:ERT Active Attackers Feed , Widgets:[{Top Malicious IP Addresses:[Attacks]},{Breakdown by Malicious Activity:[Packets]},{EAAF Hits Timeline:[Volume]}],devices:[All] |
      | Time Definitions.Date | Relative:[Weeks,2]                                                                                                                                        |
      | Schedule              | Run Every:Daily,On Time:+2m                                                                                                                               |
      | Share                 | Email:[automation.vision2@radware.com],Subject:myEdit subject,Body:myEdit body                                                                            |
      | Format                | Select: CSV                                                                                                                                               |
  ...
  Scenario: create new Top Attacking Geolocations and Breakdown by Malicious Activity and EAAF Hits Timeline2
    Given UI "Create" Report With Name "Top Attacking Geolocations and Breakdown by Malicious Activity and EAAF Hits Timeline2"
      | Template              | reportType:ERT Active Attackers Feed , Widgets:[{Top Attacking Geolocations:[Attacks]},{Breakdown by Malicious Activity:[Attacks]},{EAAF Hits Timeline:[Attacks]}],devices:[All] |
      | Logo                  | reportLogoPNG.png                                                                                                                                        |
  ...
  Scenario: create new Breakdown by Malicious Activity and EAAF Hits Timeline3
    Given UI "Create" Report With Name " Breakdown by Malicious Activity and EAAF Hits Timeline3"
      | Template              | reportType:ERT Active Attackers Feed , Widgets:[{Breakdown by Malicious Activity:[Attacks]},{EAAF Hits Timeline:[Attacks]}],devices:[All] |
      | Time Definitions.Date | Absolute:[27.02.1971 01:00, +0d]                                                                                   |
      | Schedule              | Run Every:Monthly, On Time:+6H, At Months:[MAR]                                                                    |
      | Format                | Select: HTML                                                                                                       |
  ...
  Scenario: create new All Widgets1
    Given UI "Create" Report With Name "All Widgets1"
      | Template              | reportType:ERT Active Attackers Feed , Widgets:[{Top Malicious IP Addresses:[Attacks]},{Top Attacking Geolocations:[Attacks]},{Breakdown by Malicious Activity:[Attacks]},{EAAF Hits Timeline:[Volume]},Totals in Selected Time Frame] ,devices:[All] |
      | Logo                  | reportLogoPNG.png                                                                                                                                                                                                             |
      | Time Definitions.Date | Quick:Previous Month                                                                                                                                                                                                          |
      | Format                | Select: CSV                                                                                                                                                                                                                   |
  ...
  Scenario: create new All Widgets3
    Given UI "Create" Report With Name "All Widgets3"
      | Template              | reportType:ERT Active Attackers Feed , Widgets:[{Top Malicious IP Addresses:[Volume]},{Top Attacking Geolocations:[Attacks]},{Breakdown by Malicious Activity:[Volume]},{EAAF Hits Timeline:[Volume]},Totals in Selected Time Frame],devices:[All] |
      | Time Definitions.Date | Relative:[Hours,3]                                                                                                                                                                                                           |
      | Schedule              | Run Every:Weekly, On Time:+6H, At Days:[WED]                                                                                                                                                                                 |
      | Share                 | Email:[automation.vision2@radware.com],Subject:myEdit subject,Body:myEdit body                                                                                                                                               |
      | Format                | Select: CSV                                                                                                                                                                                                                  |
