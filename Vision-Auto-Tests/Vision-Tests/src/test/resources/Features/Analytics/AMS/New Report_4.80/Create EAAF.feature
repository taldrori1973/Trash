...
Feature: EAAF
  ...
  Scenario: create new Top Malicious IP Addresses and Breakdown by Malicious Activity and EAAF Hits Timeline1
    ...
    Given UI "Create" Report With Name "Top Malicious IP Addresses and Breakdown by Malicious Activity and EAAF Hits Timeline1"
      | Template              | reportType:EAAF , Widgets:[{Top Malicious IP Addresses:[Events]},{Breakdown by Malicious Activity:[Events]},{EAAF Hits Timeline:[Events]}] |
      | Logo                  | reportLogoPNG.png                                                                                                                                             |
      | Time Definitions.Date | Quick:15m                                                                                                                                                     |
      | Format                | Select: CSV                                                                                                                                                   |
  ...
  Scenario: create new Top Malicious IP Addresses and Breakdown by Malicious Activity and EAAF Hits Timeline2
    ...
    Given UI "Create" Report With Name "Top Malicious IP Addresses and Breakdown by Malicious Activity and EAAF Hits Timeline2"
      | Template              | reportType:EAAF , Widgets:[{Top Malicious IP Addresses:[Packets]},{Breakdown by Malicious Activity:[Packets]},{EAAF Hits Timeline:[Volume]}] |
      | Logo                  | reportLogoPNG.png                                                                                                                                               |
      | Time Definitions.Date | Quick:This Week                                                                                                                                                 |
      | Schedule              | Run Every:Monthly, On Time:+6H, At Months:[AUG]                                                                                                                 |
      | Share                 | Email:[automation.vision2@radware.com],Subject:myEdit subject,Body:myEdit body                                                                                  |
  ...
  Scenario: create new Top Malicious IP Addresses and Breakdown by Malicious Activity and EAAF Hits Timeline3
    ...
    Given UI "Create" Report With Name "Top Malicious IP Addresses and Breakdown by Malicious Activity and EAAF Hits Timeline3"
      | Template              | reportType:EAAF , Widgets:[{Top Malicious IP Addresses:[Volume]},{Breakdown by Malicious Activity:[Volume]},{EAAF Hits Timeline:[Volume]}] |
      | Time Definitions.Date | Absolute:[27.02.1971 01:00, +0d]                                                                                                                              |
      | Schedule              | Run Every:Monthly, On Time:+6H, At Months:[MAR]                                                                                                               |
      | Format                | Select: HTML                                                                                                                                                  |
  ...
  Scenario: create new Top Malicious IP Addresses and Breakdown by Malicious Activity and EAAF Hits Timeline4
    ...
    Given UI "Create" Report With Name "Top Malicious IP Addresses and Breakdown by Malicious Activity and EAAF Hits Timeline4"
      | Template              | reportType:EAAF , Widgets:[{Top Malicious IP Addresses:[Events]},{Breakdown by Malicious Activity:[Packets]},{EAAF Hits Timeline:[Volume]}] |
      | Time Definitions.Date | Relative:[Weeks,2]                                                                                                                                             |
      | Schedule              | Run Every:Daily,On Time:+2m                                                                                                                                    |
      | Share                 | Email:[automation.vision2@radware.com],Subject:myEdit subject,Body:myEdit body                                                                                 |
      | Format                | Select: CSV                                                                                                                                                    |
  ...
  Scenario: create new All Widgets1
    ...
    Given UI "Create" Report With Name "All Widgets1"
      | Template              | reportType:EAAF , Widgets:[{Top Malicious IP Addresses:[Events]},{Top Attacking Geolocations:[Events]},{Breakdown by Malicious Activity:[Events]},{EAAF Hits Timeline:[Volume]},Totals in Selected Time Frame] |
      | Logo                  | reportLogoPNG.png                                                                                                                                                                                                                 |
      | Time Definitions.Date | Quick:Previous Month                                                                                                                                                                                                              |
      | Format                | Select: CSV                                                                                                                                                                                                                       |
  ...
  Scenario: create new All Widgets2
    ...
    Given UI "Create" Report With Name "All Widgets2"
      | Template              | reportType:EAAF , Widgets:[{Top Malicious IP Addresses:[Packets]},{Top Attacking Geolocations:[Packets]},{Breakdown by Malicious Activity:[Packets]},{EAAF Hits Timeline:[Volume]},Totals in Selected Time Frame] |
      | Logo                  | reportLogoPNG.png                                                                                                                                                                                                                    |
      | Time Definitions.Date | Quick:This Month                                                                                                                                                                                                                     |
      | Schedule              | Run Every:Once, On Time:+6H                                                                                                                                                                                                          |
      | Share                 | Email:[automation.vision2@radware.com],Subject:myEdit subject,Body:myEdit body                                                                                                                                                       |
  ...
  Scenario: create new All Widgets3
    ...
    Given UI "Create" Report With Name "All Widgets3"
      | Template              | reportType:EAAF , Widgets:[{Top Malicious IP Addresses:[Volume]},{Top Attacking Geolocations:[Volume]},{Breakdown by Malicious Activity:[Volume]},{EAAF Hits Timeline:[Volume]},Totals in Selected Time Frame] |
      | Time Definitions.Date | Absolute:[27.02.1971 01:00, +0d]                                                                                                                                                                                                  |
      | Schedule              | Run Every:Monthly, On Time:+6H, At Months:[MAR]                                                                                                                                                                                   |
      | Format                | Select: HTML                                                                                                                                                                                                                      |
  ...
  Scenario: create new All Widgets3
    Then UI Click Button "New Report Tab"
    Given UI "Create" Report With Name "All Widgets3"
      | Template              | reportType:EAAF , Widgets:[{Top Malicious IP Addresses:[Volume]},{Top Attacking Geolocations:[Events]},{Breakdown by Malicious Activity:[Volume]},{EAAF Hits Timeline:[Volume]},Totals in Selected Time Frame] |
      | Time Definitions.Date | Relative:[Hours,3]                                                                                                                                                                                                                |
      | Schedule              | Run Every:Weekly, On Time:+6H, At Days:[WED]                                                                                                                                                                                      |
      | Share                 | Email:[automation.vision2@radware.com],Subject:myEdit subject,Body:myEdit body                                                                                                                                                    |
      | Format                | Select: CSV                                                                                                                                                                                                                       |
