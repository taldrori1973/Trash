@DefenseProBehavioralE2E
Feature: DefensePro Behavioral E2E Test with CSV report
...
#
  ...
  Scenario: generate two attacks
    Given CLI simulate 2 attacks of type "rest_bdosdns" on "DefensePro" 10 with attack ID
    Given CLI simulate 1 attacks of type "baselines_pol_1" on "DefensePro" 10
  ...
  Scenario: Create new Report Analytics CSV Delivery
    ...
    Given UI "Create" Report With Name "DefensePro Behavioral E2E Test"
      | Template | reportType:DefensePro Behavioral Protections,Widgets:[ALL], devices:[{deviceIndex:10, devicePolicies:[P_11111111111111111111111111111111111111111111111111111111111111]}]  |
  ...
  Scenario: Validate delivery card and generate report
    Given Clear email history for user "setup"
    Then UI Generate and Validate Report With Name "DefensePro Behavioral E2E Test" with Timeout of 300 Seconds
    And Sleep "15"

  @SID_8
  Scenario: Validate Report Email received content
    #subject
    Then Validate "setup" user eMail expression "grep "Subject: DefensePro Behavioral E2E Test Subject"" EQUALS "2"
    #From
