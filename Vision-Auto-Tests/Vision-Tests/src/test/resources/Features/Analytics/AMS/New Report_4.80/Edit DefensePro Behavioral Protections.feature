...
#
  ...
  @SID_4
  Scenario: Add Template Widget to DefensePro Behavioral Protections
    Given UI "Edit" Report With Name "DefensePro Behavioral Protections Report"
      | Template-1 | reportType:DefensePro Behavioral Protections, Widgets:[{DNS-Other:[IPv4]}], devices:[{deviceIndex:11, devicePolicies:[BDOS]}] |
    Then UI "Validate" Report With Name "DefensePro Behavioral Protections Report"
      | Template-1 | reportType:DefensePro Behavioral Protections, Widgets:[DNS-SOA,DNS-Other], devices:[{deviceIndex:11, devicePolicies:[BDOS]}] |

  @SID_5
  Scenario: Add Template Widget to DefensePro Behavioral Protections
    Given UI "Edit" Report With Name "DefensePro Behavioral Protections Report"
      | Template-2 | reportType:DefensePro Behavioral Protections, Widgets:[{{BDoS-IGMP:[IPv6, bps, Outbound]}], devices:[{deviceIndex:10, devicePolicies:[BDOS]}] |
    Then UI "Validate" Report With Name "DefensePro Behavioral Protections Report"
      | Template-2 | reportType:DefensePro Behavioral Protections, Widgets:[Excluded UDP Traffic,BDoS-IGMP], devices:[{deviceIndex:10, devicePolicies:[BDOS]}] |

  @SID_6
  Scenario: Delete Template Widget from DefensePro Behavioral Protections
    Given UI "Edit" Report With Name "DefensePro Behavioral Protections Report"
      | Template-1 | reportType:DefensePro Behavioral Protections, Widgets:[{DNS-SOA:[IPv4]}], devices:[{deviceIndex:11, devicePolicies:[BDOS]}] |
    Then UI "Validate" Report With Name "DefensePro Behavioral Protections Report"
      | Template-1 | reportType:DefensePro Behavioral Protections, Widgets:[DNS-Other], devices:[{deviceIndex:11, devicePolicies:[BDOS]}] |
  ...
  Scenario: Delete Template Widget from DefensePro Behavioral Protections
    Given UI "Edit" Report With Name "DefensePro Behavioral Protections Report"
      | Template-2 | reportType:DefensePro Behavioral Protections, Widgets:[{{BDoS-IGMP:[IPv6, bps, Outbound]}], devices:[{deviceIndex:10, devicePolicies:[BDOS]}] |
    Then UI "Validate" Report With Name "DefensePro Behavioral Protections Report"
      | Template-2 | reportType:DefensePro Behavioral Protections, Widgets:[Excluded UDP Traffic], devices:[{deviceIndex:10, devicePolicies:[BDOS]}] |

  @SID_8
  Scenario: Edit Template Devices from DefensePro Behavioral Protections Report
    Given UI "Edit" Report With Name "DefensePro Behavioral Protections Report"
      | Template-1 | reportType:DefensePro Behavioral Protections,devices:[{deviceIndex:10, devicePolicies:[BDOS]}] |
    Then UI "Validate" Report With Name "DefensePro Behavioral Protections Report"
      | Template-1 | reportType:DefensePro Behavioral Protections,Widgets:[DNS-Other], devices:[{deviceIndex:10, devicePolicies:[BDOS]}] |
  ...
  Scenario: Edit Template Devices from DefensePro Behavioral Protections Report
    ...
    Then UI "Validate" Report With Name "DefensePro Behavioral Protections Report"
      | Template-2 | reportType:DefensePro Behavioral Protections,Widgets:[Excluded UDP Traffic], devices:[{deviceIndex:11, devicePolicies:[BDOS]}] |

  @SID_10
  Scenario:Add Template to DefensePro Behavioral Protections Report
    Given UI "Edit" Report With Name "DefensePro Behavioral Protections Report"
      | Template-3 | reportType:DefensePro Behavioral Protections , Widgets:[{BDoS-TCP SYN ACK:[IPv4,bps,Outbound]}] ,devices:[{deviceIndex:11, devicePolicies:[1_https]}] |
    Then UI "Validate" Report With Name "DefensePro Behavioral Protections Report"
      | Template-1 | reportType:DefensePro Behavioral Protections,Widgets:[DNS-Other], devices:[{deviceIndex:10, devicePolicies:[BDOS]}]                                   |
      | Template-2 | reportType:DefensePro Behavioral Protections,Widgets:[Excluded UDP Traffic], devices:[{deviceIndex:11, devicePolicies:[BDOS]}]                        |
      | Template-3 | reportType:DefensePro Behavioral Protections , Widgets:[{BDoS-TCP SYN ACK:[IPv4,bps,Outbound]}] ,devices:[{deviceIndex:11, devicePolicies:[1_https]}] |
