...
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/DDoS Attack Activations per Period-DefenseFlow Analytics.csv" |wc -l" on "ROOT_SERVER_CLI" and validate result EQUALS "2"
...
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/"DDoS Peak Attack per Period-DefenseFlow Analytics.csv"|head -2|tail -1|grep 1231371200000,.*,14,PO_115,80.75.0.0/32|wc -l " on "ROOT_SERVER_CLI" and validate result EQUALS "1"
#
#  @SID_9
...
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/Top 10 Activations by Attack Rate (Gbps)-DefenseFlow Analytics.csv"|head -2|tail -1|grep 1231371200000,1,14,PO_115,80.75.0.0/32|wc -l " on "ROOT_SERVER_CLI" and validate result EQUALS "1"
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/Top 10 Activations by Attack Rate (Gbps)-DefenseFlow Analytics.csv"|head -3|tail -1|grep 1151371200000,1,13,PO_114,80.74.0.0/32|wc -l " on "ROOT_SERVER_CLI" and validate result EQUALS "1"
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/Top 10 Activations by Attack Rate (Gbps)-DefenseFlow Analytics.csv"|head -4|tail -1|grep 1071371200000,1,12,PO_113,80.73.0.0/32|wc -l " on "ROOT_SERVER_CLI" and validate result EQUALS "1"
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/Top 10 Activations by Attack Rate (Gbps)-DefenseFlow Analytics.csv"|head -5|tail -1|grep 991371200000,1,11,PO_112,80.72.0.0/32|wc -l " on "ROOT_SERVER_CLI" and validate result EQUALS "1"
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/Top 10 Activations by Attack Rate (Gbps)-DefenseFlow Analytics.csv"|head -6|tail -1|grep 911371200000,1,10,PO_111,80.71.0.0/32|wc -l " on "ROOT_SERVER_CLI" and validate result EQUALS "1"
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/Top 10 Activations by Attack Rate (Gbps)-DefenseFlow Analytics.csv"|head -7|tail -1|grep 751371200000,1,9,PO_109,70.79.0.0/32|wc -l " on "ROOT_SERVER_CLI" and validate result EQUALS "1"
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/Top 10 Activations by Attack Rate (Gbps)-DefenseFlow Analytics.csv"|head -8|tail -1|grep 671371200000,1,8,PO_108,70.78.0.0/32|wc -l " on "ROOT_SERVER_CLI" and validate result EQUALS "1"
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/Top 10 Activations by Attack Rate (Gbps)-DefenseFlow Analytics.csv"|head -9|tail -1|grep 591371200000,1,7,PO_107,70.77.0.0/32|wc -l " on "ROOT_SERVER_CLI" and validate result EQUALS "1"
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/Top 10 Activations by Attack Rate (Gbps)-DefenseFlow Analytics.csv"|head -10|tail -1|grep 511371200000,1,6,PO_106,70.76.0.0/32|wc -l " on "ROOT_SERVER_CLI" and validate result EQUALS "1"
...
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/Top 10 Activations by Attack Rate (Mpps)-DefenseFlow Analytics.csv"|head -3|tail -1|grep 1,14087000000,13,PO_114,80.74.0.0/32|wc -l " on "ROOT_SERVER_CLI" and validate result EQUALS "1"
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/Top 10 Activations by Attack Rate (Mpps)-DefenseFlow Analytics.csv"|head -4|tail -1|grep 1,13087000000,12,PO_113,80.73.0.0/32|wc -l " on "ROOT_SERVER_CLI" and validate result EQUALS "1"
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/Top 10 Activations by Attack Rate (Mpps)-DefenseFlow Analytics.csv"|head -5|tail -1|grep 1,12087000000,11,PO_112,80.72.0.0/32|wc -l " on "ROOT_SERVER_CLI" and validate result EQUALS "1"
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/Top 10 Activations by Attack Rate (Mpps)-DefenseFlow Analytics.csv"|head -6|tail -1|grep 1,11087000000,10,PO_111,80.71.0.0/32|wc -l " on "ROOT_SERVER_CLI" and validate result EQUALS "1"
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/Top 10 Activations by Attack Rate (Mpps)-DefenseFlow Analytics.csv"|head -7|tail -1|grep 1,9087000000,9,PO_109,70.79.0.0/32|wc -l " on "ROOT_SERVER_CLI" and validate result EQUALS "1"
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/Top 10 Activations by Attack Rate (Mpps)-DefenseFlow Analytics.csv"|head -8|tail -1|grep 1,8087000000,8,PO_108,70.78.0.0/32|wc -l " on "ROOT_SERVER_CLI" and validate result EQUALS "1"
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/Top 10 Activations by Attack Rate (Mpps)-DefenseFlow Analytics.csv"|head -9|tail -1|grep 1,7087000000,7,PO_107,70.77.0.0/32|wc -l " on "ROOT_SERVER_CLI" and validate result EQUALS "1"
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/Top 10 Activations by Attack Rate (Mpps)-DefenseFlow Analytics.csv"|head -10|tail -1|grep 1,6087000000,6,PO_106,70.76.0.0/32|wc -l " on "ROOT_SERVER_CLI" and validate result EQUALS "1"
#    Then CLI Run linux Command "cat "/opt/radware/mgt-server/third-party/tomcat/bin/Top 10 Activations by Attack Rate (Mpps)-DefenseFlow Analytics.csv"|head -11|tail -1|grep 1,5087000000,5,PO_105,70.75.0.0/32|wc -l " on "ROOT_SERVER_CLI" and validate result EQUALS "1"
