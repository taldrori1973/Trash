@TC114570
Feature: Report Traffic Bandwidth Options
  ...
  Scenario: validate that the default selection is inbound and pps
    ...
    Then UI Validate the attribute "class" Of Label "Widget Option" With Params "pps_Traffic Bandwidth" is "NOT CONTAINS" to "selected"
    Then UI Validate the attribute "class" Of Label "Widget Option" With Params "bps_Traffic Bandwidth" is "CONTAINS" to "selected"
