...
####################################data not changing with Pcap##################################
  ...
  Scenario: validate that the data not change with pcap
    ...
    Given CLI simulate 1000 attacks of type "ErtFeed_GeoFeed" on SetId "DefensePro_Set_13" with loopDelay 15000 and wait 120 seconds
  ...
  Scenario: verify no data available in dashboard
    ...
    Then UI Text of "EAAF charts" with extension "top-attacking-countries" equal to " No data available"
    Then UI Text of "EAAF charts" with extension "breakdown-by-malicious-activity" equal to " No data available"
    Then UI Text of "EAAF charts" with extension "top-malicious-ip-Addresses" equal to " No data available"
    Then UI Text of "EAAF charts" with extension "eaaf-hits-timeline" equal to " No data available"
