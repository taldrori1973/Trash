...
# validate values ordering
  ...
  Scenario: Validate Top Attacking Countries Widget - Packets
    ...
    #      check IP bar percentage value
    Then UI Validate the attribute "fill" Of Label "Country bar" With Params "0" is "EQUALS" to "100.00%"
    Then UI Validate the attribute "fill" Of Label "Country bar" With Params "1" is "EQUALS" to "51.77%"
    Then UI Validate the attribute "fill" Of Label "Country bar" With Params "3" is "EQUALS" to "49.85%"
...
#    Validate IP addresses correctness
  ...
  Scenario: Validate Top Attacking Countries Widget - Volume
    ...
    #      check IP bar percentage value
    Then UI Validate the attribute "fill" Of Label "Country bar" With Params "0" is "EQUALS" to "100.00%"
    Then UI Validate the attribute "fill" Of Label "Country bar" With Params "1" is "EQUALS" to "52.19%"
    Then UI Validate the attribute "fill" Of Label "Country bar" With Params "2" is "EQUALS" to "50.39%"
    Then UI Validate the attribute "fill" Of Label "Country bar" With Params "3" is "EQUALS" to "49.82%"
    Then UI Validate the attribute "fill" Of Label "Country bar" With Params "4" is "EQUALS" to "22.81%"
    Then UI Validate the attribute "fill" Of Label "Country bar" With Params "5" is "EQUALS" to "5.99%"
  @SID_11
