...
#    Then UI Validate Popup Dialog Box, have value "The system is under a license violation:" with text Type "CAPTION"
    ...
    Then UI Validate Text field by id " gwt-debug-DeviceControlBar_LicenseAlertMsg_licenseAlert" CONTAINS "vision-activation license will expire within 21 days."
