...
#    Then UI Add "DefensePro" with index 9 on "DPs" site nowait
    ...
    Then UI Lock Device with type "DefensePro" and Index 11 by Tree Tab "Sites And Devices"
    Then UI verify Device Status with deviceType "defensePro" with index 11 if Expected device Status "Up or Maintenance"
    Then UI open Topology Tree view "SitesAndClusters" site
