...
Feature: System SNMP tests
  ...
  Scenario: System SNMP initial Status Tests
    Given CLI Operations - Run Radware Session command "net dns set primary 10.220.20.7"
...
#    Then CLI System Snmp Community Delete
    ...
    Then CLI Run linux Command "cat /etc/snmp/snmpd.conf |grep "com2sec.*public" |wc -l" on "ROOT_SERVER_CLI" and validate result EQUALS "0"
