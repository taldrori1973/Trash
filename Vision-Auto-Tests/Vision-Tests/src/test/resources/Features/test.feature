...
Feature:test
  ...
  Scenario: create new Output Destination Port Equals
    When UI "Create" Forensics With Name "Output Destination Port Equals"
      ...
      | Criteria | Event Criteria:Action,Operator:Equals,Value:[Modified,Source Reset,Source and Destination Reset,Http 200 Ok,Http 403 Forbidden Reset Dest];Event Criteria:Attack ID,Operator:Not Equals,Value:123; Event Criteria:Attack ID,Operator:Not Equals,Value:1234;condition.All:true;condition.All:true;  |
      |Criteria1 |condition.All:true|
      | devices  | All                                                                                                                                      |
