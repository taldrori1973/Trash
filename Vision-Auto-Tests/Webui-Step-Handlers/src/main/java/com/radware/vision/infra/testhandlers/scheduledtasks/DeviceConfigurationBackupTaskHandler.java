...
public class DeviceConfigurationBackupTaskHandler extends BaseTasksHandler{
	...
	public static void addTask(HashMap<String, String> taskProperties) throws Exception {
		...
		taskEntity.getParameters().setIncludePrivateKeys(Boolean.valueOf(taskProperties.get("includePrivateKeys")));
